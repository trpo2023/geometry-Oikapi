...
int check_real_lenght(struct Figure main_check_circle) {
    int k = 0;
    for (int i = 0; i < (int) sizeof(main_check_circle.thirdx) / (int) sizeof(main_check_circle.thirdx[0]); i++) {
...
int check_x(char string[], int n, int *main_error) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        if (((int) string[i] > (int) ('9') || (int) string[i] < (int) ('0')) && ((int) string[i] != minus && (int) string[i] != dot)) {
            *main_error = 3;
            return i + 1;
        }
    }
...
int check_radius(char string[], int n, int *main_error) {
    ...
    for (int i = 0; i < n - 1; i++) {
        ...
        if (((int) string[i] > (int) ('9') || (int) string[i] < (int) ('0')) && string[i] != (int) ('.')) {
            *main_error = 3;
            return i + 1;
        }
    }
...
void print_error(int main_error) {
    ...
    if (main_error == 10) printf("radius must be greater than zero");
